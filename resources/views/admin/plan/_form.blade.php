    ...
    <form method="post" action="{{ route('admin/plan/save') }}" enctype="multipart/form-data" id="ajax-form">
        @csrf
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="basic-icon-default-title" placeholder="Title"
                                name="title" aria-label="title" id="title" required="required"
                                value="{{ @$model->title }}" />
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label" for="basic-icon-default-fullname">Description <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="basic-icon-default-fullname">Duration <span
                                    class="text-danger">*</span></label>
                            <select class="form-select" data-style="btn-default" name="duration" aria-label="Duration">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="basic-icon-default-fullname">Status <span
                                    class="text-danger">*</span></label>
                            <select class="form-select" data-style="btn-default" name="status" aria-label="Status" name="status">
        ...
        <a href="admin/plan" class="btn btn-dark pjax" style="color: white;">Back</a>
    </form>
