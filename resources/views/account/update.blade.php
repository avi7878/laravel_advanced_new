        ...
        <div class="card-body">
          <div class="d-flex align-items-start align-items-sm-center gap-6 pb-4 border-bottom">
              ...
              <div class="button-wrapper">
                  <a onclick="app.showModalView('account/image')" for="upload" class="btn btn-primary me-3 mb-4 text-white pjax" tabindex="0">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('account/deactivate') }}" id="formAccountDeactivation" method="POST">
                            ...
                            <div class="form-check my-8 ms-2">
                                <input type="checkbox" class="form-check-input" name="accountActivation"
